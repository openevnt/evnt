...
export const TimeSchema = z
	...
	.meta({ description: "Time in HH:mm format" }) as z.ZodType<ActivityTime>;

export const DurationSchema = z
	.string()
	.regex(/^\d{1,}:\d{2}$/, "Duration must be in H:mm format")
	.meta({
		description: "Duration in HH:mm format, where hours can be more than 24",
	}) as z.ZodType<ActivityDuration>;
